...
my $OUTPUT_HOME = "ROUGE-EVAL"; #where to generate output 
my $DIR_SYSTEM="DUC-2007/SYSTEM"; # location of system generated files
my $DIR_GOLD="DUC-2007/GOLD"; # location of gold standard files

#`rm -r $OUTPUT_HOME `;

`rm -r $OUTPUT_HOME/systems`;
`rm -r $OUTPUT_HOME/models`;


`mkdir -p $OUTPUT_HOME `;
`mkdir -p $OUTPUT_HOME/systems `;
`mkdir -p $OUTPUT_HOME/models `;
