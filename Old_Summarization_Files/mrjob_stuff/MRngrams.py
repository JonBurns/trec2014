...
class MRn_grams(MRJob):
    ...
    def mapper(self, _, line):
        ...
        for i in range(len(words)):
            ...
            #     score += 2
            self.increment_counter('group', 'unigram', 1)
            ...
            self.increment_counter('group', 'bigram', 1)
            ...
            #     score += 3 + in_query_so_far
            self.increment_counter('group', 'trigram', 1)
    ...
    #This part could potentially be removed as probability could be calculated with a counter instead
